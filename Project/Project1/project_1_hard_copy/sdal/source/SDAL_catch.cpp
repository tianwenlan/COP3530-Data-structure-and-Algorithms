...
TEST_CASE("push_front()"){
	...
	SECTION("when push 10000 elements"){
		...
		for(int i =0; i< 10000; ++i){
			...
			REQUIRE(l.item_at(i+1)=='B');
			REQUIRE(l.item_at(i+2)=='A');
			REQUIRE(l.item_at(0)=='O');
		}
	}
}
...
TEST_CASE("SDAL& operator=(const SDAL& src)"){
	cop3530::SDAL<char> src;
	cop3530::SDAL<char> l;
...
//	}
	...
	SECTION("end()"){
		cop3530::SDAL<char>::iterator iter = l.end();
	...
	SECTION("test operator=()"){
		...
		cop3530::SDAL<char>::iterator iter1;
...
//		REQUIRE_FALSE(*(iter++)=='A');
	...
	SECTION("test operator==()"){
		...
		cop3530::SDAL<char>::iterator iter = l.begin();
		cop3530::SDAL<char>::iterator iter1 = l.end();

		cop3530::SDAL<char>::iterator iter2 = l1.begin();
...
TEST_CASE("Const_Iterator"){
	...
	SECTION("begin()"){
		cop3530::SDAL<char>::const_iterator const_iter = const_list->begin();
	...
	SECTION("end()"){
		cop3530::SDAL<char>::const_iterator const_iter = const_list->end();
	...
	SECTION("test operator=()"){
		...
		cop3530::SDAL<char>::const_iterator const_iter1;
...
//		REQUIRE_FALSE(*(const_iter++)=='O');
	...
	SECTION("test operator==()"){
		...
		const cop3530::SDAL<char> *const_list1 = &l1;

		cop3530::SDAL<char>::const_iterator const_iter = const_list->begin();
		cop3530::SDAL<char>::const_iterator const_iter1 = const_list->end();

		cop3530::SDAL<char>::const_iterator const_iter2 = const_list->begin();
	...
	SECTION("test operator!=()"){
		...
		cop3530::SDAL<char>::const_iterator const_iter2 = const_list1->begin();
