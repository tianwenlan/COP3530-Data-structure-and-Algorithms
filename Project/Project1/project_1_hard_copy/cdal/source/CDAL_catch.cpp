...
TEST_CASE("CDAL& operator=(const CDAL& src)"){
	cop3530::CDAL<char> src;
	cop3530::CDAL<char> l;
...
//	}
	...
	SECTION("end()"){
		cop3530::CDAL<char>::iterator iter = l.end();
	...
	SECTION("test operator=()"){
		...
		cop3530::CDAL<char>::iterator iter1;
...
//		REQUIRE_FALSE(*(iter++)=='A');
	...
	SECTION("test operator==()"){
		...
		cop3530::CDAL<char>::iterator iter = l.begin();
		cop3530::CDAL<char>::iterator iter1 = l.end();

		cop3530::CDAL<char>::iterator iter2 = l1.begin();
...
TEST_CASE("Const_Iterator"){
	...
	SECTION("end()"){
		cop3530::CDAL<char>::const_iterator const_iter = const_list->end();
	...
	SECTION("test operator=()"){
		...
		cop3530::CDAL<char>::const_iterator const_iter1;
...
//		REQUIRE_FALSE(*(const_iter++)=='O');
	...
	SECTION("test operator==()"){
		...
		const cop3530::CDAL<char> *const_list1 = &l1;

		cop3530::CDAL<char>::const_iterator const_iter = const_list->begin();
		cop3530::CDAL<char>::const_iterator const_iter1 = const_list->end();

		cop3530::CDAL<char>::const_iterator const_iter2 = const_list->begin();
	...
	SECTION("test operator!=()"){
		...
		cop3530::CDAL<char>::const_iterator const_iter2 = const_list1->begin();
