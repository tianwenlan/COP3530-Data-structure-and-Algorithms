// SDAL_test.cpp
// 
// Purpose: test Simple Dynamic Array-based List (SDAL)
//
// by Wenlan
// for COP 3530
// 09/23/2014
...
int main() {
	...
	const cop3530::SDAL<char> list=l;
...
//	l.remove(20000);  //throw an exception
	...
	///////iterator/////
		...
		//test begin() and *()
		cop3530::SDAL<char>::iterator iter_begin = l.begin();
		...
		//test end() and *()
		cop3530::SDAL<char>::iterator iter_end = l.end();
	...
	///////const_iterator/////
		...
		//test begin() and *()
		cop3530::SDAL<char>::const_iterator const_iter_begin = const_list->begin();
		...
		//test end() and *()
		cop3530::SDAL<char>::const_iterator const_iter_end = const_list->end();
		...
		//test operator==() and operator!=() 
		const cop3530::SDAL<char> *const_l1 = &l;
		
		cop3530::SDAL<char>::const_iterator const_iter2 = const_l1->begin();
