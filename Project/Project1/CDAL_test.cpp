// CDAL_test.cpp
// 
// Purpose: test my Chained Dynamic Array-based List (CDAL)
/// Author: Wenlan Tian
// Date: 09-28-1014
//
// =========================================================================
...
int main() {
	...
	const cop3530::CDAL<char> list=l;
...
//	l.remove(20000);  //throw an exception
	...
	///////iterator/////
		...
		//test begin() and *()
		cop3530::CDAL<char>::iterator iter_begin = l.begin();
		...
		//test end() and *()
		cop3530::CDAL<char>::iterator iter_end = l.end();
	...
	///////const_iterator/////
		...
		//test begin() and *()
		cop3530::CDAL<char>::const_iterator const_iter_begin = const_list->begin();
		...
		//test end() and *()
		cop3530::CDAL<char>::const_iterator const_iter_end = const_list->end();
		...
		//test operator==() and operator!=() 
		const cop3530::CDAL<char> *const_l1 = &l;
		
		cop3530::CDAL<char>::const_iterator const_iter2 = const_l1->begin();
