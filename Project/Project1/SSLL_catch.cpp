...
TEST_CASE("SSLL& operator=(const SSLL& src)"){
	cop3530::SSLL<char> src;
	cop3530::SSLL<char> l;
...
TEST_CASE("T const& operator[](int i) const"){
	...
	l.push_back('B');
	 ...
	 const cop3530::SSLL<char> list=l;

	 
	 
	SECTION("position >=0 and <=size()"){
		REQUIRE_THROWS(list[-5]);	
		REQUIRE_THROWS(list[10000]);
	}
	...
	SECTION("random position"){
		REQUIRE (list[1500]=='O');
		REQUIRE_FALSE(list[1500]=='X');

//		list[1500]='X';  // ILLEGAL!  Won't compile!  Denotes constant element 
		REQUIRE (list[1500]=='O');
		REQUIRE_FALSE (list[1500]=='X');
	}	
}
...
TEST_CASE("Iterator"){
	...
	SECTION("end()"){
		cop3530::SSLL<char>::iterator iter = l.end();
	...
	SECTION("test operator=()"){
		...
		cop3530::SSLL<char>::iterator iter1;
...
//		REQUIRE_FALSE(*(iter++)=='A');
	...
	SECTION("test operator==()"){
		...
		cop3530::SSLL<char>::iterator iter = l.begin();
		cop3530::SSLL<char>::iterator iter1 = l.end();

		cop3530::SSLL<char>::iterator iter2 = l1.begin();
...
TEST_CASE("Const_Iterator"){
	...
	SECTION("end()"){
		cop3530::SSLL<char>::const_iterator const_iter = const_list->end();

		SECTION("test operator*()"){
		//	REQUIRE(*const_iter == NULL);
		}
	}
	...
	SECTION("test operator=()"){
		...
		cop3530::SSLL<char>::const_iterator const_iter1;
...
//		REQUIRE_FALSE(*(const_iter++)=='O');
	...
	SECTION("test operator==()"){
		...
		const cop3530::SSLL<char> *const_list1 = &l1;

		cop3530::SSLL<char>::const_iterator const_iter = const_list->begin();
		cop3530::SSLL<char>::const_iterator const_iter1 = const_list->end();

		cop3530::SSLL<char>::const_iterator const_iter2 = const_list->begin();
	...
	SECTION("test operator!=()"){
		...
		cop3530::SSLL<char>::const_iterator const_iter2 = const_list1->begin();
