...
set output 'histogram_Chi_wtu.png'
...
set xtics   ()
set title "Chi-square of different hash function using war-and-peace_tolstoi-unique.txt" 
i = 22
plot 'hash_Chi_wtu.dat' using 2:xtic(1) title columnheader(2), for [i=3:14] '' using i title columnheader(i)
