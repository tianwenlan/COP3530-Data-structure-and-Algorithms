...
set output 'histogram_Chi_location.png'
...
set xtics   ()
set title "Chi-square of different hash function using localities-location.txt" 
i = 22
plot 'hash_Chi_location.dat' using 2:xtic(1) title columnheader(2), for [i=3:14] '' using i title columnheader(i)
