...
set output 'histogram_Chi_cau.png'
...
set xtics   ()
set title "Chi-square of different hash function using confucian-analects-unique.txt"
i = 22
plot 'hash_Chi_cau.dat' using 2:xtic(1) title columnheader(2), for [i=3:14] '' using i title columnheader(i)
