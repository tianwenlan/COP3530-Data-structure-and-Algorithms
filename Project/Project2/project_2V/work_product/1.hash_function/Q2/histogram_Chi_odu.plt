...
set output 'histogram_Chi_odu.png'
...
set xtics   ()
set title "Chi-square of different hash function using origin-of-the-species_darwin-unique.txt" 
i = 22
plot 'hash_Chi_odu.dat' using 2:xtic(1) title columnheader(2), for [i=3:14] '' using i title columnheader(i)
